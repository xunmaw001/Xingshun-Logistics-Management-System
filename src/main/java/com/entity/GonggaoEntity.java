...
public class GonggaoEntity<T> implements Serializable {
     ...
     * 物流资讯名称
     */
    @ColumnInfo(comment="物流资讯名称",type="varchar(200)")
     ...
     * 物流资讯类型
     */
    @ColumnInfo(comment="物流资讯类型",type="int(11)")
	...
	@DateTimeFormat
    @ColumnInfo(comment="物流资讯发布时间",type="timestamp")
     ...
     * 物流资讯详情
     */
    @ColumnInfo(comment="物流资讯详情",type="longtext")
