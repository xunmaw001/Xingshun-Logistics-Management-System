  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='kehu'"  label='客户邮箱' prop="kehuEmail">
               <el-input v-model="ruleForm.kehuEmail"  placeholder='客户邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag!='users' &&( 1==2|| flag=='yuangong'
|| flag=='kehu')"  label="性别" prop="sexTypes">
