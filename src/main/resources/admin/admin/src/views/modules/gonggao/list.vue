        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '物流资讯名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.gonggaoName" placeholder="物流资讯名称" clearable></el-input>
                     </el-form-item>
         
                     <el-form-item :label="contents.inputTitle == 1 ? '物流资讯类型' : ''">
                        <el-select v-model="searchForm.gonggaoTypes" placeholder="请选择物流资讯类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <el-button
                                ...
                                @click="chartDialog()"
                        >物流资讯类型分布统计</el-button>
                        &nbsp;
                        <a style="text-decoration:none" class="el-button el-button--success"
                           v-if="isAuth('gonggao','导入导出')"
                           icon="el-icon-download"
                           href="http://localhost:8080/xingshunwuliu/upload/gonggaoMuBan.xls"
                        >批量导入物流资讯数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('gonggao','导入导出')"
