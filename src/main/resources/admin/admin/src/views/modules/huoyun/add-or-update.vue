    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12" v-if="sessionTable !='jiashiyuan' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jiashiyuanPhoto" label="驾驶员照片" prop="jiashiyuanPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (jiashiyuanForm.jiashiyuanPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12" v-if="sessionTable !='jiashiyuan' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jiashiyuanJiazhaoPhoto" label="驾照照片" prop="jiashiyuanJiazhaoPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (jiashiyuanForm.jiashiyuanJiazhaoPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='jiashiyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="性别" prop="sexValue">
                        <el-input v-model="jiashiyuanForm.sexValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='jiashiyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="驾驶员邮箱" prop="jiashiyuanEmail">
                        <el-input v-model="jiashiyuanForm.jiashiyuanEmail"
                                  placeholder="驾驶员邮箱" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12" v-if="sessionTable !='kehu' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kehuPhoto" label="客户头像" prop="kehuPhoto">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kehuPhoto" label="客户头像" prop="kehuPhoto">
            ...
            <input id="cheliangId" name="cheliangId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单编号" prop="huoyunUuidNumber">
                       <el-input v-model="ruleForm.huoyunUuidNumber"
                                 placeholder="订单编号" clearable  :readonly="ro.huoyunUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单编号" prop="huoyunUuidNumber">
                           <el-input v-model="ruleForm.huoyunUuidNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物品标题" prop="huoyunName">
                       <el-input v-model="ruleForm.huoyunName"
                                 placeholder="物品标题" clearable  :readonly="ro.huoyunName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="物品标题" prop="huoyunName">
                           <el-input v-model="ruleForm.huoyunName"
                                     placeholder="物品标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="货运类型" prop="huoyunTypes">
                        <el-select v-model="ruleForm.huoyunTypes" :disabled="ro.huoyunTypes" placeholder="请选择货运类型">
                            <el-option
                                v-for="(item,index) in huoyunTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="货运类型" prop="huoyunValue">
                        <el-input v-model="ruleForm.huoyunValue"
                            placeholder="货运类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物品重量" prop="huoyunZhongliang">
                       <el-input v-model="ruleForm.huoyunZhongliang"
                                 placeholder="物品重量" clearable  :readonly="ro.huoyunZhongliang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="物品重量" prop="huoyunZhongliang">
                           <el-input v-model="ruleForm.huoyunZhongliang"
                                     placeholder="物品重量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物品长" prop="huoyunChang">
                       <el-input v-model="ruleForm.huoyunChang"
                                 placeholder="物品长" clearable  :readonly="ro.huoyunChang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="物品长" prop="huoyunChang">
                           <el-input v-model="ruleForm.huoyunChang"
                                     placeholder="物品长" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物品宽" prop="huoyunKuan">
                       <el-input v-model="ruleForm.huoyunKuan"
                                 placeholder="物品宽" clearable  :readonly="ro.huoyunKuan"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="物品宽" prop="huoyunKuan">
                           <el-input v-model="ruleForm.huoyunKuan"
                                     placeholder="物品宽" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物品高" prop="huoyunGao">
                       <el-input v-model="ruleForm.huoyunGao"
                                 placeholder="物品高" clearable  :readonly="ro.huoyunGao"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="物品高" prop="huoyunGao">
                           <el-input v-model="ruleForm.huoyunGao"
                                     placeholder="物品高" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="货运金额" prop="huoyunJine">
                       <el-input v-model="ruleForm.huoyunJine"
                                 placeholder="货运金额" clearable  :readonly="ro.huoyunJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="货运金额" prop="huoyunJine">
                           <el-input v-model="ruleForm.huoyunJine"
                                     placeholder="货运金额" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="出发地" prop="huoyunChufadi">
                       <el-input v-model="ruleForm.huoyunChufadi"
                                 placeholder="出发地" clearable  :readonly="ro.huoyunChufadi"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="出发地" prop="huoyunChufadi">
                           <el-input v-model="ruleForm.huoyunChufadi"
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="出发时间" prop="chufaTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.chufaTime"
                                type="datetime"
                                placeholder="出发时间"
                                :disabled="ro.chufaTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chufaTime" label="出发时间" prop="chufaTime">
                            <span v-html="ruleForm.chufaTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="途径地" prop="huoyunTujing">
                       <el-input v-model="ruleForm.huoyunTujing"
                                 placeholder="途径地" clearable  :readonly="ro.huoyunTujing"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="途径地" prop="huoyunTujing">
                           <el-input v-model="ruleForm.huoyunTujing"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="抵达地" prop="huoyunDidadi">
                       <el-input v-model="ruleForm.huoyunDidadi"
                                 placeholder="抵达地" clearable  :readonly="ro.huoyunDidadi"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="抵达地" prop="huoyunDidadi">
                           <el-input v-model="ruleForm.huoyunDidadi"
                                     placeholder="抵达地" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && sessionTable!='yuangong'"  class="input" label="送达时间" prop="songdaTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.songdaTime"
                                type="datetime"
                                placeholder="送达时间"
                                :disabled="ro.songdaTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.songdaTime" label="送达时间" prop="songdaTime">
                            <span v-html="ruleForm.songdaTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.wupinContent"  label="物品备注" prop="wupinContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wupinContent" label="物品备注" prop="wupinContent">
                            <span v-html="ruleForm.wupinContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.huoyunContent"  label="货运备注" prop="huoyunContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.huoyunContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.huoyunContent" label="货运备注" prop="huoyunContent">
                            <span v-html="ruleForm.huoyunContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info' && sessionTable!='yuangong'"  label="运输状态" prop="yushuTypes">
                        <el-select v-model="ruleForm.yushuTypes" :disabled="ro.yushuTypes" placeholder="请选择运输状态">
                            <el-option
                                v-for="(item,index) in yushuTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="运输状态" prop="yushuValue">
                        <el-input v-model="ruleForm.yushuValue"
                            placeholder="运输状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && sessionTable!='yuangong'"  label="评价" prop="huoyunPingjiaContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.huoyunPingjiaContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.huoyunPingjiaContent" label="评价" prop="huoyunPingjiaContent">
                            <span v-html="ruleForm.huoyunPingjiaContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    jiashiyuanId: false,
                    cheliangId: false,
                    huoyunUuidNumber: false,
                    huoyunName: false,
                    wupinTypes: false,
                    huoyunTypes: false,
                    huoyunZhongliang: false,
                    huoyunChang: false,
                    huoyunKuan: false,
                    huoyunGao: false,
                    huoyunJine: false,
                ...
                ruleForm: {
                    ...
                    jiashiyuanId: '',
                    cheliangId: '',
                    huoyunUuidNumber: new Date().getTime(),
                    huoyunName: '',
                    wupinTypes: '',
                    huoyunTypes: '',
                    huoyunZhongliang: '',
                ...
                rules: {
                   ...
                   huoyunTypes: [
                              { required: true, message: '货运类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   huoyunChang: [
                              { required: true, message: '物品长不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   huoyunKuan: [
                              { required: true, message: '物品宽不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   huoyunGao: [
                              { required: true, message: '物品高不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   huoyunJine: [
                              { required: true, message: '货运金额不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   huoyunTujing: [
                              { required: true, message: '途径地不能为空', trigger: 'blur' },
                          ],
                   huoyunDidadi: [
                              { required: true, message: '抵达地不能为空', trigger: 'blur' },
                          ],
                   songdaTime: [
                              { required: true, message: '送达时间不能为空', trigger: 'blur' },
                          ],
                   wupinContent: [
                              { required: true, message: '物品备注不能为空', trigger: 'blur' },
                          ],
                   huoyunContent: [
                              { required: true, message: '货运备注不能为空', trigger: 'blur' },
                          ],
                   yushuTypes: [
        ...
        created() {
            ...
            if (this.role == "客户"){
                  ...
                  this.ro.jiashiyuanId=true;
                  this.ro.cheliangId=true;
                  this.ro.huoyunUuidNumber=true;
                  this.ro.huoyunName=true;
                  this.ro.wupinTypes=true;
                  this.ro.huoyunTypes=true;
                  this.ro.huoyunZhongliang=true;
                  this.ro.huoyunChang=true;
                  this.ro.huoyunKuan=true;
                  this.ro.huoyunGao=true;
                  this.ro.huoyunJine=true;
                  this.ro.huoyunChufadi=true;
                  this.ro.chufaTime=true;
                  this.ro.huoyunTujing=true;
                  this.ro.huoyunDidadi=true;
                  this.ro.songdaTime=true;
                  this.ro.wupinContent=true;
                  this.ro.huoyunContent=true;
                  this.ro.yushuTypes=true;
                  this.ro.huoyunPingjiaContent=false;
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=huoyun_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.huoyunTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yushu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yushuTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.wupinContent = _this.ruleForm.wupinContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                        _this.ruleForm.huoyunContent = _this.ruleForm.huoyunContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                        _this.ruleForm.huoyunPingjiaContent = _this.ruleForm.huoyunPingjiaContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.wupinContent = this.ruleForm.wupinContent.replaceAll(this.$base.url,"");
                        this.ruleForm.huoyunContent = this.ruleForm.huoyunContent.replaceAll(this.$base.url,"");
                        this.ruleForm.huoyunPingjiaContent = this.ruleForm.huoyunPingjiaContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`huoyun/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.huoyunCrossAddOrUpdateFlag = false;
                                        this.parent.search();
