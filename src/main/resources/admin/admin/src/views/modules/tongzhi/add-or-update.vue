        ...
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="通知内容" prop="tongzhiText">
                        <el-input type="textarea"  :readonly="ro.tongzhiText" v-model="ruleForm.tongzhiText" placeholder="通知内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.tongzhiText" label="通知内容" prop="tongzhiText">
                            <span v-html="ruleForm.tongzhiText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
